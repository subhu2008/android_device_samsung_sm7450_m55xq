...
static void fod_enable(void *device_data)
{
    ...
    /*M55 code for P240702-04756 by hehaoran at 20240704 start*/
    /*
    **111 ==>enable shot strict ==> 00000010=0x02
    **110 ==>enable shot normal ==> 01000010=0x42
    **101 ==>enable long strict ==> 10000010=0x82
    **100 ==>enable long normal ==> 11000010=0xc2
    **bit1 : 1 enable fod / 0 disable fod
    **bit7 : 1 long / 0 short mode
    **bit6 : 1 normal / 0 strict mode
    */
    if (sec->cmd_param[0] < 0 || sec->cmd_param[0] > 1) {
        goto NG;
    } else {
        ...
        if (sec->cmd_param[0] == 0) {
            ...
            value = ((sec->cmd_param[0] & 0x01) << 1) | (!(sec->cmd_param[1] & 0x01) << 7)
                | (!(sec->cmd_param[2] & 0x01) << 6) ;
        }
    ...
    /*M55 code for P240702-04756 by hehaoran at 20240704 end*/
