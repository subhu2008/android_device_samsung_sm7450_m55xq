...
/* M55 code for SR-QN6887A-01-164 by renxingin at 20231130 start */
#define O3101LY_FRONT_HI5022Q_CN      "o3101ly_front_hi5022q_cn"
#define O3101LY_FRONT_HI5022Q_KR      "o3101ly_front_hi5022q_kr"
#define O3102XL_FRONT_HI5022Q         "o3102xl_front_hi5022q"
#define O3101LY_FRONT_HI5022Q_CN_QCFA "o3101ly_front_hi5022q_cn_qcfa"
#define O3101LY_FRONT_HI5022Q_KR_QCFA "o3101ly_front_hi5022q_kr_qcfa"
#define O3102XL_FRONT_HI5022Q_QCFA    "o3102xl_front_hi5022q_qcfa"
#define O3102TXD_BACK_HI5011Q         "o3102txd_back_hi5011q"
#define O3103LY_BACK_HI5011Q          "o3103ly_back_hi5011q"
#define O3102TXD_BACK_HI5011Q_QCFA    "o3102txd_back_hi5011q_qcfa"
#define O3103LY_BACK_HI5011Q_QCFA     "o3103ly_back_hi5011q_qcfa"
#define O3101QT_BACK_S5KGN5           "o3101qt_back_s5kgn5"
#define O3102TXD_BACK_S5KGN5          "o3102txd_back_s5kgn5"
#define O3103LY_BACK_S5KGN5           "o3103ly_back_s5kgn5"
#define O3101QT_BACK_S5KGN5_QCFA      "o3101qt_back_s5kgn5_qcfa"
#define O3102TXD_BACK_S5KGN5_QCFA     "o3102txd_back_s5kgn5_qcfa"
#define O3103LY_BACK_S5KGN5_QCFA      "o3103ly_back_s5kgn5_qcfa"
/* M55 code for SR-QN6887A-01-164 by renxingin at 20231130 end */
...
int cam_sensor_match_id(struct cam_sensor_ctrl_t *s_ctrl)
{
    ...
    /*M55  code for QN6887A-52 by renxinglin at 2023/09/12 start*/
    char *compat_sensor_name;
    uint32_t cam_module_id;
    char *module_sensor_name = "NULL_NAME";
    ...
    compat_sensor_name = s_ctrl->sensor_name;
    CAM_DBG(CAM_SENSOR,"sensor_name = %s",compat_sensor_name);

    if((0 == strcmp(compat_sensor_name, O3101LY_FRONT_HI5022Q_CN))||
       (0 == strcmp(compat_sensor_name, O3101LY_FRONT_HI5022Q_KR))||
       (0 == strcmp(compat_sensor_name, O3102XL_FRONT_HI5022Q)))
    {
        s_ctrl->io_master_info.cci_client->sid = 0xA6 >> 1;
        CAM_DBG(CAM_SENSOR, "hi5022 cci_client->sid = 0x%x", (s_ctrl->io_master_info.cci_client->sid) << 1);
        camera_io_dev_read(&(s_ctrl->io_master_info), 0x0002, &cam_module_id, CAMERA_SENSOR_I2C_TYPE_WORD, CAMERA_SENSOR_I2C_TYPE_BYTE);
        CAM_DBG(CAM_SENSOR, "hi5022_module_id = 0x%x", cam_module_id);
        if(cam_module_id == 0x5A)
        {
            module_sensor_name = O3101LY_FRONT_HI5022Q_CN;
        }
        else if(cam_module_id == 0x5B)
        {
            module_sensor_name = O3101LY_FRONT_HI5022Q_KR;
        }
        else if(cam_module_id == 0x5C)
        {
            module_sensor_name = O3102XL_FRONT_HI5022Q;
        }
        else
        {
            CAM_ERR(CAM_SENSOR,"This front hi5022q camera have no eeprom");
        }
        s_ctrl->io_master_info.cci_client->sid = 0x40 >> 1;      //0x40 sensor IIC address
        if((0 != strcmp(compat_sensor_name, module_sensor_name)) && (0 != strcmp("NULL_NAME", module_sensor_name)))
        {
            return -ENODEV;
        }
    }
    else if((0 == strcmp(compat_sensor_name, O3101LY_FRONT_HI5022Q_CN_QCFA))||
            (0 == strcmp(compat_sensor_name, O3101LY_FRONT_HI5022Q_KR_QCFA))||
            (0 == strcmp(compat_sensor_name, O3102XL_FRONT_HI5022Q_QCFA)))
    {
        s_ctrl->io_master_info.cci_client->sid = 0xA6 >> 1;
        CAM_DBG(CAM_SENSOR,"hi5022_qcfa cci_client->sid = 0x%x", (s_ctrl->io_master_info.cci_client->sid) << 1);
        camera_io_dev_read(&(s_ctrl->io_master_info), 0x0002, &cam_module_id, CAMERA_SENSOR_I2C_TYPE_WORD, CAMERA_SENSOR_I2C_TYPE_BYTE);
        CAM_DBG(CAM_SENSOR,"hi5022_qcfa_module_id = 0x%x", cam_module_id);
        if(cam_module_id == 0x5A)
        {
            module_sensor_name = O3101LY_FRONT_HI5022Q_CN_QCFA;
        }
        else if(cam_module_id == 0x5B)
        {
            module_sensor_name = O3101LY_FRONT_HI5022Q_KR_QCFA;
        }
        else if(cam_module_id == 0x5C)
        {
            module_sensor_name = O3102XL_FRONT_HI5022Q_QCFA;
        }
        else
        {
            CAM_ERR(CAM_SENSOR," This front hi5022q_qcfa camera have no eeprom");
        }
        s_ctrl->io_master_info.cci_client->sid = 0x40 >> 1;      //0x40 sensor IIC address
        if(0 != strcmp(compat_sensor_name, module_sensor_name) && (0 != strcmp("NULL_NAME", module_sensor_name)))
        {
    ...
    /*M55  code for SR-QN6887A-01-805 by cuichaoyi at 20231016 start*/
	if((0 == strcmp(compat_sensor_name, O3102TXD_BACK_HI5011Q))||
       (0 == strcmp(compat_sensor_name, O3103LY_BACK_HI5011Q)))
    {
        s_ctrl->io_master_info.cci_client->sid = 0xA0 >> 1;
        CAM_DBG(CAM_SENSOR, "hi5011 cci_client->sid = 0x%x", (s_ctrl->io_master_info.cci_client->sid) << 1);
        camera_io_dev_read(&(s_ctrl->io_master_info), 0x0002, &cam_module_id, CAMERA_SENSOR_I2C_TYPE_WORD, CAMERA_SENSOR_I2C_TYPE_BYTE);
        CAM_DBG(CAM_SENSOR, "hi5011_module_id = 0x%x", cam_module_id);
        if(cam_module_id == 0x52)
        {
            module_sensor_name = O3102TXD_BACK_HI5011Q;
        }
        else if(cam_module_id == 0x53)
        {
            module_sensor_name = O3103LY_BACK_HI5011Q;
        }
        else
        {
            CAM_ERR(CAM_SENSOR,"This back hi5011q camera have no eeprom");
        }
        s_ctrl->io_master_info.cci_client->sid = 0x46 >> 1;      //0x46 sensor IIC address
        if((0 != strcmp(compat_sensor_name, module_sensor_name)) && (0 != strcmp("NULL_NAME", module_sensor_name)))
        {
            return -ENODEV;
        }
    }
	else if((0 == strcmp(compat_sensor_name, O3102TXD_BACK_HI5011Q_QCFA))||
       (0 == strcmp(compat_sensor_name, O3103LY_BACK_HI5011Q_QCFA)))
    {
        s_ctrl->io_master_info.cci_client->sid = 0xA0 >> 1;
        CAM_DBG(CAM_SENSOR,"hi5011_qcfa cci_client->sid = 0x%x", (s_ctrl->io_master_info.cci_client->sid) << 1);
        camera_io_dev_read(&(s_ctrl->io_master_info), 0x0002, &cam_module_id, CAMERA_SENSOR_I2C_TYPE_WORD, CAMERA_SENSOR_I2C_TYPE_BYTE);
        CAM_DBG(CAM_SENSOR,"hi5011_qcfa_module_id = 0x%x", cam_module_id);
        if(cam_module_id == 0x52)
        {
            module_sensor_name = O3102TXD_BACK_HI5011Q_QCFA;
        }
        else if(cam_module_id == 0x53)
        {
            module_sensor_name = O3103LY_BACK_HI5011Q_QCFA;
        }
        else
        {
            CAM_ERR(CAM_SENSOR," This front hi5011q_qcfa camera have no eeprom");
        }
        s_ctrl->io_master_info.cci_client->sid = 0x46 >> 1;      //0x46 sensor IIC address
        if(0 != strcmp(compat_sensor_name, module_sensor_name) && (0 != strcmp("NULL_NAME", module_sensor_name)))
        {
    ...
    /* M55 code for SR-QN6887A-01-164 by renxingin at 20231130 start */
	if((0 == strcmp(compat_sensor_name, O3101QT_BACK_S5KGN5))  ||
	   (0 == strcmp(compat_sensor_name, O3102TXD_BACK_S5KGN5)) ||
       (0 == strcmp(compat_sensor_name, O3103LY_BACK_S5KGN5)))
	{
        s_ctrl->io_master_info.cci_client->sid = 0xA0 >> 1;     //read eeprom module id
        CAM_DBG(CAM_SENSOR, "s5kgn5 cci_client->sid = 0x%x", (s_ctrl->io_master_info.cci_client->sid) << 1);
        camera_io_dev_read(&(s_ctrl->io_master_info), 0x0002, &cam_module_id, CAMERA_SENSOR_I2C_TYPE_WORD, CAMERA_SENSOR_I2C_TYPE_BYTE);
        CAM_DBG(CAM_SENSOR, "s5kgn5_module_id = 0x%x", cam_module_id);
        if(cam_module_id == 0x51)
        {
            module_sensor_name = O3101QT_BACK_S5KGN5;
        }
        else if(cam_module_id == 0x54)
        {
            module_sensor_name = O3102TXD_BACK_S5KGN5;
        }
        else if(cam_module_id == 0x55)
        {
            module_sensor_name = O3103LY_BACK_S5KGN5;
        }
        else
        {
            CAM_ERR(CAM_SENSOR,"BugGag This back s5kgn5 camera have no eeprom");
        }
        s_ctrl->io_master_info.cci_client->sid = 0xAC >> 1;      //0xAC sensor IIC address
        if((0 != strcmp(compat_sensor_name, module_sensor_name)) && (0 != strcmp("NULL_NAME", module_sensor_name)))
        {
            return -ENODEV;
        }
    }
    else if((0 == strcmp(compat_sensor_name, O3101QT_BACK_S5KGN5_QCFA))  ||
            (0 == strcmp(compat_sensor_name, O3102TXD_BACK_S5KGN5_QCFA)) ||
            (0 == strcmp(compat_sensor_name, O3103LY_BACK_S5KGN5_QCFA)))
    {
        s_ctrl->io_master_info.cci_client->sid = 0xA0 >> 1;     //read eeprom module id
        CAM_DBG(CAM_SENSOR, "s5kgn5_qcfa cci_client->sid = 0x%x", (s_ctrl->io_master_info.cci_client->sid) << 1);
        camera_io_dev_read(&(s_ctrl->io_master_info), 0x0002, &cam_module_id, CAMERA_SENSOR_I2C_TYPE_WORD, CAMERA_SENSOR_I2C_TYPE_BYTE);
        CAM_DBG(CAM_SENSOR, "s5kgn5_qcfa_module_id = 0x%x", cam_module_id);
        if(cam_module_id == 0x51)
        {
            module_sensor_name = O3101QT_BACK_S5KGN5_QCFA;
        }
        else if(cam_module_id == 0x54)
        {
            module_sensor_name = O3102TXD_BACK_S5KGN5_QCFA;
        }
        else if(cam_module_id == 0x55)
        {
            module_sensor_name = O3103LY_BACK_S5KGN5_QCFA;
        }
        else
        {
            CAM_ERR(CAM_SENSOR,"BugGag This back s5kgn5_qcfa camera have no eeprom");
        }
        s_ctrl->io_master_info.cci_client->sid = 0xAC >> 1;      //0xAC sensor IIC address
        if((0 != strcmp(compat_sensor_name, module_sensor_name)) && (0 != strcmp("NULL_NAME", module_sensor_name)))
        {
    ...
    /* M55 code for SR-QN6887A-01-164 by renxinglin at 20231130 end */
